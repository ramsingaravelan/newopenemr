...
if (isset($_POST["privatemode"]) && $_POST["privatemode"] =="user_admin") {
    if ($_POST["mode"] == "update") {
      ...
      //Display message when Emergency Login user was activated
        ...
        if ($_POST["doctors_id_proof_number"]) {
            sqlStatement("update users set doctors_id_proof_number = ? where id = ? ", array($_POST["doctors_id_proof_number"], $_POST["id"]));
        }
    ...
    if ($_POST["mode"] == "new_user") {
        ...
        if ($doit == true) {
          ...
          //if password expiration option is enabled,  calculate the expiration date of the password
            ...
            "', doctors_id_proof_number = '"  . add_escape_custom(trim((isset($_POST['doctors_id_proof_number']) ? $_POST['doctors_id_proof_number'] : ''))) .
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th><?php echo xlt('Doctors ID proof number'); ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($result4 as $iter) {
                            ...
                            print "<tr>
                                ...
                                <td>" . text($iter{"doctors_id_proof_number"}) . "&nbsp;</td>
