...
<tr>
<td><span class="text"><?php echo xlt('doctors ID proof number'); ?>: </span></td><td><input type="text" name='doctors_id_proof_number' style="width:120px;" class="form-control"></td>
