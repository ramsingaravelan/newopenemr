...
<!--<tbody>
    ...
    <div class="buttons">
    <a href="fliter.php" class="btn btn-danger">Report Generate of gender</a>
    <a href="daterangefilter.php" class="btn btn-danger">Report Generate of daterange</a>
    <a href="newdatatable.php" class="btn btn-danger">Report Generate of mutifilter</a>
    </div>
    </div>
