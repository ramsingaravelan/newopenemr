<?php /* Smarty version 2.6.31, created on 2022-08-25 14:46:39
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 10, false),array('function', 'xla', 'default/views/day/ajax_template.html', 186, false),array('function', 'xlt', 'default/views/day/ajax_template.html', 186, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 418, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 413, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 414, false),)), $this); ?>
...
<div id="viewPicker">
    <button type="button" class="btn btn-primary btn css_button" data-toggle="modal" data-target="#exampleModal">
        Date
      </button>
<?php 
...
echo "   <a href='#' type=''  id='dateview' title='" . xla('') . "' class=''  /><span>" . xlt('') . "</span></a>\n";
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Current Date</h5>
