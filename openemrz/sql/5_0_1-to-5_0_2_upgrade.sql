...
#EndIf
#IfMissingColumn users doctors_id_proof_number
ALTER TABLE `users` ADD `doctors_id_proof_number` VARCHAR(25) default NULL ;
#EndIf

#IfMissingColumn facility stat
ALTER TABLE `facility` ADD `stat` tinyint(10);
#EndIf
